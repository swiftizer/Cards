...
class CardSetsVC: UIViewController {
    ...
    private func setupUI() {
        ...
        navigationItem.leftBarButtonItem = .init(image: UIImage(systemName: "gearshape")?.withTintColor(ProcessInfo.processInfo.environment["PG_USER_NAME"] == "web_reader" ? .label : .red, renderingMode: .alwaysOriginal), style: .done, target: self, action: #selector(didTapSettingsButton))
